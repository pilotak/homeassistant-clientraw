...
class ClientrawData(object):
    ...
    async def async_update(self, *_):
        ...
        for dev in self.devices:
            ...
            if dev.type == 'symbol':
                if self.data[48] != '-' and self.data[48] != '--' and self.data[48] != '---':
                    new_state = int(self.data[48])
                else:
                    new_state = STATE_UNAVAILABLE

            elif dev.type == 'daily_rain':
                if self.data[7] != '-' and self.data[7] != '--' and self.data[7] != '---':
                ...
                if self.data[19] != '-' and self.data[19] != '--' and self.data[19] != '---':
                ...
                if self.data[8] != '-' and self.data[8] != '--' and self.data[8] != '---':
                ...
                if self.data[9] != '-' and self.data[9] != '--' and self.data[9] != '---':
                ...
                if self.data[10] != '-' and self.data[10] != '--' and self.data[10] != '---':
                ...
                if self.data[4] != '-' and self.data[4] != '--' and self.data[4] != '---':
                ...
                if self.data[12] != '-' and self.data[12] != '--' and self.data[12] != '---':
                ...
                if self.data[2] != '-' and self.data[2] != '--' and self.data[2] != '---':
                ...
                if self.data[1] != '-' and self.data[1] != '--' and self.data[1] != '---':
                ...
                if self.data[158] != '-' and self.data[158] != '--' and self.data[158] != '---':
                ...
                if self.data[133] != '-' and self.data[133] != '--' and self.data[133] != '---':
                ...
                if self.data[71] != '-' and self.data[71] != '--' and self.data[71] != '---':
                ...
                if self.data[6] != '-' and self.data[6] != '--' and self.data[6] != '---':
                ...
                if self.data[3] != '-' and self.data[3] != '--' and self.data[3] != '---':
                ...
                if self.data[5] != '-' and self.data[5] != '--' and self.data[5] != '---':
                    new_state = float(self.data[5])
                else:
                    new_state = STATE_UNAVAILABLE

            elif dev.type == 'humidity_indoor':
                if self.data[13] != '-' and self.data[13] != '--' and self.data[13] != '---':
                    new_state = float(self.data[13])
                else:
                    new_state = STATE_UNAVAILABLE

            elif dev.type == 'cloud_height':
                if self.data[73] != '-' and self.data[73] != '--' and self.data[73] != '---':
                ...
                if self.data[72] != '-' and self.data[72] != '--' and self.data[72] != '---':
                ...
                if self.data[112] != '-' and self.data[112] != '--' and self.data[112] != '---':
                ...
                if self.data[44] != '-' and self.data[44] != '--' and self.data[44] != '---':
                ...
                if self.data[15] != '-' and self.data[15] != '--' and self.data[15] != '---':
                ...
                if self.data[47] != '-' and self.data[47] != '--' and self.data[47] != '---':
